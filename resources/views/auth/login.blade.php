...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <p class="auth-description">Please sign-in to your account and continue to the dashboard.<br>Don't have an account? <a href="javscript::void()">Sign Up</a></p>
            <form action="{{ route('login') }}" method="POST">
                @csrf
                {{-- csrf full meaning is cross site request forgery --}}
